...
class WatermarkEmbedder:
    def __init__(self, carrier_image_path:str="images/che.png", watermark_image_path:str="images/watermark.png", segment_size:int=5, 
                 ...
                 keypoints_metadata=None,output_dir:str="res",channel=0,max_keypoints:int=None)->None:
        ...
        if self.carrier_image_colour is None:
        ...
        if  self.watermark_imaget is None:
        ...
        if  self.water_mark_segments is None:
    ...
    def embed(self,)->dict:
        ...
        sorted_keypoints_desc=sorted(zip(keypoints,decss), key=lambda point:point[0].response,reverse=True)
        ...
        for key_point, decs in sorted_keypoints_desc:
            ...
            if x-half_segment < 0 or y-half_segment<0 or x+half_segment>=width or y+half_segment>=height:
                continue;
            ...
            selected_keypoints.append((key_point, decs))
        ...
        output_path:str =f"{self.carrier_image_path}_watermarked.png"
        ...
        output_meta_path:str =f"{self.carrier_image_path[:-4]}_meta.json"
